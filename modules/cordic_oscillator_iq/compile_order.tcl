...
if {$this_module_compiled eq 0} {
    ...
    puts -nonewline $simulator_comporder "\
        ./modules/cordic_oscillator_iq/sim/cordic_oscillator_iq_tb.sv\n"
    ...
    add_files -fileset "sources_1" -norecurse {\
        ./modules/cordic_sin_cos/hdl/cordic_sin_cos_iter.sv\
        ./modules/cordic_sin_cos/hdl/cordic_sin_cos.sv\
        ./modules/cordic_oscillator_iq/hdl/cordic_oscillator_iq.sv\
    }
