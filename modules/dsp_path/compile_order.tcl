...
if {$this_module_compiled eq 0} {
    ...
    puts -nonewline $simulator_comporder "\
        ./modules/dsp_path/sim/dsp_path_tb.sv\n"
    ...
    add_files -fileset "sources_1" -norecurse {\
        ./modules/ddc/hdl/ddc.sv\
        ./modules/fir_parallel/hdl/fir_parallel_coeff.svh\
        ./modules/fir_parallel/hdl/fir_parallel.sv\
        ./modules/averager/hdl/averager.sv\
        ./modules/dsp_path/hdl/dsp_path.sv\
    }
