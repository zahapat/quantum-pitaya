...
proc create_root_design { parentCell } {
    ...
    # Create ports
    # create_bd_port -dir I -type clk -freq_hz 125000000 M_AXI_GP0_ACLK
    # create_bd_port -dir I -type clk -freq_hz 125000000 S_AXI_HP0_aclk
    # create_bd_port -dir I -type clk -freq_hz 125000000 S_AXI_HP1_aclk
    # create_bd_port -dir I -type clk -freq_hz 125000000 S_AXI_HP2_aclk
    # create_bd_port -dir I -type clk -freq_hz 125000000 S_AXI_HP3_aclk
    ...
    # connect_bd_net -net processing_system7_0_fclk_clk3 [get_bd_pins processing_system7_0/FCLK_CLK3] [get_bd_pins processing_system7_0/M_AXI_GP0_ACLK]
    connect_bd_net [get_bd_pins processing_system7_0/FCLK_CLK2] [get_bd_pins processing_system7_0/M_AXI_GP0_ACLK]

    # connect_bd_net -net s_axi_hp0_aclk [get_bd_ports S_AXI_HP0_aclk] [get_bd_pins processing_system7_0/S_AXI_GP0_ACLK] [get_bd_pins processing_system7_0/S_AXI_HP0_ACLK]
    # connect_bd_net -net s_axi_hp1_aclk [get_bd_ports S_AXI_HP1_aclk] [get_bd_pins processing_system7_0/S_AXI_HP1_ACLK]
    # connect_bd_net -net s_axi_hp2_aclk [get_bd_ports S_AXI_HP2_aclk] [get_bd_pins processing_system7_0/S_AXI_HP2_ACLK]
    # connect_bd_net -net s_axi_hp3_aclk [get_bd_ports S_AXI_HP3_aclk] [get_bd_pins processing_system7_0/S_AXI_HP3_ACLK]

    # Create instance: processing_system7_0, and set properties
    create_bd_port -dir I -type clk -freq_hz 125000000 in_adc_clk_0
    create_bd_cell -type module -reference top_redpitaya_daq_wrapper top_redpitaya_daq_wrapper_0

    startgroup
    make_bd_pins_external  [get_bd_pins top_redpitaya_daq_wrapper_0/dac_o_data]
    make_bd_pins_external  [get_bd_pins top_redpitaya_daq_wrapper_0/dac_o_iqsel]
    make_bd_pins_external  [get_bd_pins top_redpitaya_daq_wrapper_0/dac_o_iqclk]
    make_bd_pins_external  [get_bd_pins top_redpitaya_daq_wrapper_0/dac_o_iqwrt]
    make_bd_pins_external  [get_bd_pins top_redpitaya_daq_wrapper_0/dac_o_iqrst]
    make_bd_pins_external  [get_bd_pins top_redpitaya_daq_wrapper_0/adc_i_clkstb]
    make_bd_pins_external  [get_bd_pins top_redpitaya_daq_wrapper_0/leds]
    # make_bd_pins_external  [get_bd_pins top_redpitaya_daq_wrapper_0/in_adc_clk]
    make_bd_pins_external  [get_bd_pins top_redpitaya_daq_wrapper_0/in_data_ch1]
    make_bd_pins_external  [get_bd_pins top_redpitaya_daq_wrapper_0/in_data_ch2]
    endgroup

    # Create instance: axi4lite_fifo_readou_0, and set properties
    create_bd_cell -type module -reference axi4lite_fifo_readout_wrapper axi4lite_fifo_readou_0
    apply_bd_automation -rule xilinx.com:bd_rule:axi4 -config { Clk_master {/processing_system7_0/FCLK_CLK2} Clk_slave {Auto} Clk_xbar {Auto} Master {/processing_system7_0/M_AXI_GP0} Slave {/axi4lite_fifo_readou_0/s00_axi} ddr_seg {Auto} intc_ip {New AXI Interconnect} master_apm {0}}  [get_bd_intf_pins axi4lite_fifo_readou_0/s00_axi]

    startgroup
        connect_bd_net -net in_adc_clk_0 [get_bd_ports in_adc_clk_0] [get_bd_pins top_redpitaya_daq_wrapper_0/in_adc_clk]
        connect_bd_net [get_bd_pins top_redpitaya_daq_wrapper_0/aclk] [get_bd_pins processing_system7_0/FCLK_CLK2]
        connect_bd_net [get_bd_pins top_redpitaya_daq_wrapper_0/o_fifo_data_ch1] [get_bd_pins axi4lite_fifo_readou_0/i_fifo_data_ch1]
        connect_bd_net [get_bd_pins axi4lite_fifo_readou_0/i_fifo_data_ch1_valid] [get_bd_pins top_redpitaya_daq_wrapper_0/o_fifo_data_ch1_valid]
        connect_bd_net [get_bd_pins top_redpitaya_daq_wrapper_0/i_fifo_rd_dready] [get_bd_pins axi4lite_fifo_readou_0/o_fifo_rd_dready]
    endgroup


    # Edit Address Segments: Red Pitaya Free Address Range
    set_property offset 0x40600000 [get_bd_addr_segs {processing_system7_0/Data/SEG_axi4lite_fifo_readou_0_reg0}]
