...
proc create_root_design { parentCell } {
    ...
    # Create instance: top_redpitaya_125_14_0, and set properties
    ...
    create_bd_cell -type module -reference top_redpitaya_125_14_wrapper top_redpitaya_125_14_0
    startgroup
    set_property -dict [list CONFIG.INT_DIFF_ADC_CLK {1}] [get_bd_cells top_redpitaya_125_14_0]
    endgroup

    # Create port connections: Make external
    startgroup
    make_bd_pins_external  [get_bd_pins top_redpitaya_125_14_0/dac_o_data]
    make_bd_pins_external  [get_bd_pins top_redpitaya_125_14_0/dac_o_iqsel]
    make_bd_pins_external  [get_bd_pins top_redpitaya_125_14_0/dac_o_iqclk]
    make_bd_pins_external  [get_bd_pins top_redpitaya_125_14_0/dac_o_iqwrt]
    make_bd_pins_external  [get_bd_pins top_redpitaya_125_14_0/dac_o_iqrst]
    make_bd_pins_external  [get_bd_pins top_redpitaya_125_14_0/adc_i_clkstb]
    make_bd_pins_external  [get_bd_pins top_redpitaya_125_14_0/leds]
    make_bd_pins_external  [get_bd_pins top_redpitaya_125_14_0/in_data_ch1]
    make_bd_pins_external  [get_bd_pins top_redpitaya_125_14_0/in_data_ch2]
    make_bd_pins_external  [get_bd_pins top_redpitaya_125_14_0/i_acc_trigger_1]
    make_bd_pins_external  [get_bd_pins top_redpitaya_125_14_0/i_acc_trigger_2]
    endgroup

    # Create the AXI Lite design: Run designn automation
    apply_bd_automation -rule xilinx.com:bd_rule:axi4 -config { Clk_master {/processing_system7_0/FCLK_CLK0} Clk_slave {Auto} Clk_xbar {Auto} Master {/processing_system7_0/M_AXI_GP0} Slave {/top_redpitaya_125_14_0/s00_axi} ddr_seg {Auto} intc_ip {New AXI Interconnect} master_apm {0}}  [get_bd_intf_pins top_redpitaya_125_14_0/s00_axi]
    # apply_bd_automation -rule xilinx.com:bd_rule:axi4 -config { Clk_master {/processing_system7_0/FCLK_CLK1} Clk_slave {Auto} Clk_xbar {Auto} Master {/processing_system7_0/M_AXI_GP0} Slave {/top_redpitaya_125_14_0/s00_axi} ddr_seg {Auto} intc_ip {New AXI Interconnect} master_apm {0}}  [get_bd_intf_pins top_redpitaya_125_14_0/s00_axi]
    # apply_bd_automation -rule xilinx.com:bd_rule:axi4 -config { Clk_master {/processing_system7_0/FCLK_CLK3} Clk_slave {Auto} Clk_xbar {Auto} Master {/processing_system7_0/M_AXI_GP0} Slave {/top_redpitaya_125_14_0/s00_axi} ddr_seg {Auto} intc_ip {New AXI Interconnect} master_apm {0}}  [get_bd_intf_pins top_redpitaya_125_14_0/s00_axi]
    # apply_bd_automation -rule xilinx.com:bd_rule:axi4 -config { Clk_master {/processing_system7_0/FCLK_CLK2} Clk_slave {Auto} Clk_xbar {Auto} Master {/processing_system7_0/M_AXI_GP0} Slave {/top_redpitaya_125_14_0/s00_axi} ddr_seg {Auto} intc_ip {New AXI Interconnect} master_apm {0}}  [get_bd_intf_pins top_redpitaya_125_14_0/s00_axi]

    # Correct/update the design automation
    startgroup
    connect_bd_net -net in_adc_clk_p_0 [get_bd_ports in_adc_clk_p_0] [get_bd_pins top_redpitaya_125_14_0/in_adc_clk_p]
    connect_bd_net -net in_adc_clk_n_0 [get_bd_ports in_adc_clk_n_0] [get_bd_pins top_redpitaya_125_14_0/in_adc_clk_n]
    endgroup


    # Edit Address Segments: Red Pitaya Free Address Range
    set_property offset 0x40600000 [get_bd_addr_segs {processing_system7_0/Data/SEG_top_redpitaya_125_14_0_reg0}]
